...
<%
    ...
    for (Product cartProduct:cartProducts) {
		...
		out.print("<td> \n" +
				...
				"\t\t\t<var class=\"price\">&#x20a6; " + cartProduct.getPrice() + "</var> \n" +
...
<div class="alert alert-success mt-3">
	<% if(price>=400) {
			delivery=0;
			out.print("<p class=\"icontext\"><i class=\"icon text-success fa fa-truck\"></i> Free Delivery for this order - Subtotal price is higher than &#x20a6; 400</p>");
	}
	%>
</div>
		...
		<div class="card">
			<div class="card-body">
					<dl class="dlist-align">
					  <dt>Subtotal:</dt>
					  <dd class="text-right">&#x20a6; <% out.print(price); %></dd>
					</dl>
					<dl class="dlist-align">
					  <dt>Discount:</dt>
					  <dd class="text-right">
