    ...
    public boolean newUser(String sFirstName, String sLastName, String sUserName, String sUserPassword,  Integer age, String country, String city, Integer zipcode, String address) {
        ...
        try {
            ...
            if (!rs.next()) {
                ...
                sql = "INSERT INTO customers (firstname, lastname, username, email, password, age, country, city, zipcode, address) " +
                        "values ('" + sFirstName + "', '" + sLastName + "', '" + sUserName + "','"+ sUserName +"', MD5('" + sUserPassword + "'), '"+ age +"', '"+ country +"', '"+ city +"', '"+ zipcode +"', '"+ address +"' );";
